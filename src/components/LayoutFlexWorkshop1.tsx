    ...
    return (
        <div>
            ...
            <div className='section1'>
                ...
                <div className="flex content-start gap-8 pt-[7.5em] pb-[3em]">
            ...
            <div className='section3'>
                ...
                <div className="card-container">
                    <div className="card1">
                        ...
                        <div className='flex justify-center absolute mt-[-15.3em] ml-[8.6em] bg-gray-100  rounded-full w-[70px] h-[26px] bg-opacity-30 gap-2 content-center'>
                            <p className='text-white'>5.0</p>
                            <span><FaStar className='text-white mt-[4px]' /></span>
                        </div>
